...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      {/* Navigation */}
      <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${isScrolled ? 'bg-black/90 backdrop-blur-lg shadow-lg shadow-purple-500/5' : 'bg-transparent'}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-lg sm:text-2xl font-bold text-white">GhostChat</span>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <div className="inline-flex items-center space-x-2 bg-purple-500/10 border border-purple-500/20 rounded-full px-4 py-2 mb-8">
              ...
              <span className="text-purple-300 text-sm">End-to-End Encrypted Messaging</span>
            </div>
            ...
            <p className="text-base sm:text-xl text-gray-300 mb-8 sm:mb-12 max-w-2xl mx-auto">
              Experience truly private conversations with military-grade encryption. 
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-8 max-w-3xl mx-auto">
              <div className="bg-zinc-900/50 backdrop-blur-sm rounded-lg p-4 sm:p-6 border border-zinc-800">
                <div className="text-2xl sm:text-3xl font-bold text-purple-400 mb-2">256-bit</div>
                <div className="text-sm sm:text-base text-gray-400">AES Encryption</div>
              </div>
              <div className="bg-zinc-900/50 backdrop-blur-sm rounded-lg p-4 sm:p-6 border border-zinc-800">
                <div className="text-2xl sm:text-3xl font-bold text-cyan-400 mb-2">100%</div>
                <div className="text-sm sm:text-base text-gray-400">Private & Secure</div>
              </div>
              <div className="bg-zinc-900/50 backdrop-blur-sm rounded-lg p-4 sm:p-6 border border-zinc-800">
                <div className="text-2xl sm:text-3xl font-bold text-pink-400 mb-2">Zero</div>
                <div className="text-sm sm:text-base text-gray-400">Data Collection</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="features" className="py-12 sm:py-20 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-gray-300 text-base sm:text-lg">Everything you need for secure communication</p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-8">
            ...
            <div className="bg-zinc-900/50 backdrop-blur-sm rounded-xl p-4 sm:p-8 border border-zinc-800 hover:border-purple-500/50 transition-all duration-300 hover:transform hover:scale-105">
              ...
              <h3 className="text-base sm:text-xl font-semibold text-white mb-2 sm:mb-3">End-to-End Encryption</h3>
              <p className="text-xs sm:text-base text-gray-300">Military-grade encryption ensures your messages are completely private and secure.</p>
            </div>
            ...
            <div className="bg-zinc-900/50 backdrop-blur-sm rounded-xl p-4 sm:p-8 border border-zinc-800 hover:border-cyan-500/50 transition-all duration-300 hover:transform hover:scale-105">
              ...
              <h3 className="text-base sm:text-xl font-semibold text-white mb-2 sm:mb-3">Real-Time Messaging</h3>
              <p className="text-xs sm:text-base text-gray-300">Instant message delivery with read receipts and typing indicators.</p>
            </div>
            ...
            <div className="bg-zinc-900/50 backdrop-blur-sm rounded-xl p-4 sm:p-8 border border-zinc-800 hover:border-pink-500/50 transition-all duration-300 hover:transform hover:scale-105">
              ...
              <h3 className="text-base sm:text-xl font-semibold text-white mb-2 sm:mb-3">Group Chats</h3>
              <p className="text-xs sm:text-base text-gray-300">Create secure group conversations with friends, family, or teams.</p>
            </div>
            ...
            <div className="bg-zinc-900/50 backdrop-blur-sm rounded-xl p-4 sm:p-8 border border-zinc-800 hover:border-purple-500/50 transition-all duration-300 hover:transform hover:scale-105">
              ...
              <h3 className="text-base sm:text-xl font-semibold text-white mb-2 sm:mb-3">File Sharing</h3>
              <p className="text-xs sm:text-base text-gray-300">Share encrypted files, images, and videos securely with anyone.</p>
            </div>
            ...
            <div className="bg-zinc-900/50 backdrop-blur-sm rounded-xl p-4 sm:p-8 border border-zinc-800 hover:border-cyan-500/50 transition-all duration-300 hover:transform hover:scale-105">
              ...
              <h3 className="text-base sm:text-xl font-semibold text-white mb-2 sm:mb-3">Dark Mode</h3>
              <p className="text-xs sm:text-base text-gray-300">Beautiful dark theme designed for comfortable late-night conversations.</p>
            </div>
            ...
            <div className="bg-zinc-900/50 backdrop-blur-sm rounded-xl p-4 sm:p-8 border border-zinc-800 hover:border-pink-500/50 transition-all duration-300 hover:transform hover:scale-105">
              ...
              <h3 className="text-base sm:text-xl font-semibold text-white mb-2 sm:mb-3">Smart Notifications</h3>
              <p className="text-xs sm:text-base text-gray-300">Stay updated with customizable notifications for important messages.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Security Section */}
      <section id="security" className="py-12 sm:py-20 px-4 sm:px-6 bg-zinc-950/50">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4 sm:mb-6">Your Privacy is Our Priority</h2>
              <p className="text-gray-300 text-base sm:text-lg mb-6 sm:mb-8">
                GhostChat uses industry-leading encryption technology to ensure your conversations 
                remain completely private. We can't read your messages, and neither can anyone else.
              </p>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="text-white font-semibold mb-1">Zero Knowledge Architecture</h4>
                    <p className="text-gray-300">We never store your encryption keys on our servers.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="text-white font-semibold mb-1">Open Source Security</h4>
                    <p className="text-gray-300">Our encryption code is open for security audits.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="text-white font-semibold mb-1">No Data Mining</h4>
                    <p className="text-gray-300">We don't sell your data or show you ads.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-500/10 to-cyan-500/10 rounded-2xl p-8 border border-zinc-800">
              <div className="bg-black/80 rounded-lg p-6 font-mono text-sm">
                <div className="text-purple-400 mb-2">// Your message encryption</div>
                <div className="text-gray-300">
                  <span className="text-cyan-400">const</span> encrypted = <span className="text-pink-400">encrypt</span>(
                  <br />
      ...
      <section className="py-12 sm:py-20 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-base sm:text-xl text-gray-300 mb-6 sm:mb-8">
            Join thousands of users who trust GhostChat for their private conversations.
          </p>
          <Link href="/register">
      ...
      <footer className="border-t border-zinc-800 py-12 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="border-t border-zinc-800 pt-8 text-center text-gray-500 text-sm">
            <p>© 2026 GhostChat. All rights reserved. Built with ❤️ for privacy.</p>
          </div>
        </div>
      </footer>
